...
export function FocusModeWrapper({
  ...
  const handleTap = (e: React.MouseEvent<HTMLDivElement>) => {
    ...
    // Only detect taps on the background area (not on text or interactive elements)
  ...
  // In focus mode - full screen overlay
  return (
    <div
      ref={containerRef}
      className={cn(
      ...
      onClick={handleTap}
    >
      {/* Desktop: centered with hover toolbar */}
      {!isMobile && (
        <div className="relative w-full h-full max-w-5xl p-8 group/focus">
          {/* Content scaled with container queries */}
          <div
      ...
      {/* Mobile: full screen with double-tap toolbar */}
      {isMobile && (
