 ...
 * This is now PRIMARILY A CLIENT-SIDE construct, parsed from the raw markdown.
 */
export interface Segment {
  id: string;
  order: number;
  content: MultilingualContent;
  type: 'text' | 'heading1' | 'heading2'; // Added type for UI rendering
}
 ...
 * This is now a CLIENT-SIDE construct, generated by parsing raw markdown.
 */
 ...
 * ✅ UPDATED: No longer has a 'chapters' array.
 */
 ...
 * ✅ UPDATED: No longer has 'generatedContent'.
 */
