...
export default {
  ...
  safelist: [
    ...
    'text-level-orange',
    'bg-gradient-to-br',
    'border-b-level-purple',
    'border-b-level-pink',
    'border-b-level-orange',
  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        input: 'hsl(var(--input))',
        ring: 'hsl(var(--ring))',
        'level-silver': 'hsl(var(--level-silver))',
        'level-blue': 'hsl(var(--level-blue))',
        'level-green': 'hsl(var(--level-green))',
        'level-purple': 'hsl(var(--level-purple))',
        'level-pink': 'hsl(var(--level-pink))',
        'level-gold': 'hsl(var(--level-gold))',
        'level-orange': 'hsl(var(--level-orange))',
        chart: {
          '1': 'hsl(var(--chart-1))',
          '2': 'hsl(var(--chart-2))',
          '3': 'hsl(var(--chart-3))',
